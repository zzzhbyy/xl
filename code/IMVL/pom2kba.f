...
C-----------------------------------------------------------------------
C
       netcdf_file='pom2kba.nc'  ! netCDF output file
...
C        do j=1,jm
C
C          h(i,j)=4500.e0*(1.e0-delh
C     $                          *exp(-((east_c(i,j)
c     $                                   -east_c((im+1)/2,j))**2
c     $                                +(north_c(i,j)
c     $                                   -north_c(i,(jm+1)/2))**2)
c     $                                /ra**2))
c          if(h(i,j).lt.1.e0) h(i,j)=1.e0
C
c        end do
c      end do
      ...
      do i=1,im
        do j=1,jm
C
C          h(i,j)=4500.e0*(1.2e0-1.e0/cosh(k_le*(east_c(i,j)-xm_le)))
